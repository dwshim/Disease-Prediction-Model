...
#dtc = LogisticRegression(solver='lbfgs')
#dtc.fit(trainX, trainY)

#DecisionTreeClassifier Model
from sklearn.tree import DecisionTreeClassifier
dtc = DecisionTreeClassifier(criterion='entropy',max_depth=188, min_samples_split=20, random_state=99)
dtc.fit(trainX, trainY)

from sklearn.tree import export_graphviz
predictors=testX.columns.values
with open('C:/Users/Daniel/Downloads/COMP309/Project2/pr2_sec001_gr3_dtree.dot', 'w') as dotfile:
...
score = np.mean(cross_val_score(dtc, trainX, trainY, scoring='accuracy', cv=crossvalidation, n_jobs=1))
...
testY_predict = dtc.predict(testX)
testY_predict.dtype
...
import joblib 
joblib.dump(dtc, 'C:/Users/Daniel/Downloads/COMP309/Project2/pr2_sec001_gr3_bk_api.pkl')
print("Model dumped!")
